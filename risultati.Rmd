...
conditional_effects(mod2, categorical = TRUE, effects = "sngr")
conditional_effects(mod2, categorical = TRUE, effects = "smnc")
conditional_effects(mod2, categorical = TRUE, effects = "Grcompl")
```
