...
<p style="color:red">
Il confronto tra gradi deve essere fatto condizionalmente allo stato microbiologico, data la struttura gerarchica dei dati.
</p>
...
<p style="color:red">
In realtà è già stato fatto con la suddivisione del numero di granulomi per grado e stato microbiologico, ve lo ripropongo  </p>
...
<p style="color:blue">
In pratica valutare se a parità di area linfonodale considerata, i linfonodi aventi un’area totale di granulomi in generale (1+2+3+4) o un’area totale dei granulomi di grado X superiore ad una certa soglia sono predittivi per positività microbiologica. </p>
